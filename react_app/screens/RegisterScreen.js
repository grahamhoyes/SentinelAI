      ...
      <View style={styles.container}>
        <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
          ...
          <View style={styles.textContainer}>
            ...
            <TextInput
              style={{height: 40}}
              placeholder="Please input the new user's name"
              onChangeText={(new_person) => this.setState({new_person})}
            />
          </View>

          <View style={styles.textContainer}>
            <Button onPress={this._register} title="Register New User" color="#94e087"/>
          </View>
        </ScrollView>
